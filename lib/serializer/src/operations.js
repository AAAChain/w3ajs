...
export const data_asset_create = new Serializer(
    "data_asset_create",
    {fee: asset,
...
export const data_asset_update = new Serializer(
    "data_asset_update",
    {
        fee: asset,
        ownerId: protocol_id_type("account"),
...
export const data_transfer = new Serializer(
    "data_transfer",
    {
        fee: asset,
        from: protocol_id_type("account"),
        to: protocol_id_type("account"),
        data_asset_id: object_id_type,
        amount: asset,
        memo: optional(memo_data),
        extensions: set(future_extensions)
    }
